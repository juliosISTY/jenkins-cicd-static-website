pipeline {
    environment {
        ...
        API_ENDPOINT = "ip10-0-1-3-cebne3oj3e60g67j2k40-1996.direct.docker.labs.eazytraining.fr"
        STG_APP_ENDPOINT = "ip10-0-1-3-cebne3oj3e60g67j2k40-81.direct.docker.labs.eazytraining.fr"
    ...
    stages {
        ...
        stage('Test image') {
            ...
            steps {
                script {
                    sh '''
                        curl http://127.17.0.1 | grep -i "Dimension"
                    '''
